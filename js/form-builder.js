...
const App = {
    template: `
<div class="app-container" @keyup.delete="deleteSelectedElement($event)" tabindex="0">
        <header>
            ...
            <section id="form-builder">
                ...
                <aside id="properties">
                    <div v-if="selectedElement">
                        ...
                        <!-- Duplizieren und Löschen Buttons -->
    ...
    methods: {
        ...
        addElementToPreview(element) {
            console.log("Element hinzugefügt:", element);
